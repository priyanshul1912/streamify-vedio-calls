...
// import useSignUp from "../hooks/useSignUp"; // Commented out until hook is available
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            ...
            <div className="relative aspect-square max-w-sm mx-auto">
              <img src="/Online world-cuate.svg" alt="Language connection illustration" className="w-full h-full object-contain" />
            </div>
