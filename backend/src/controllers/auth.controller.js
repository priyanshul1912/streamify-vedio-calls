...
export  async function signup(req, res){ // FIX: Swapped req and res parameters
...
const randomAvatar = `https://api.dicebear.com/9.x/adventurer/svg?seed=User${idx}`;
...
export async function onboard(req,res){
  try {
   ...
   const updatedUser =  await User.findByIdAndUpdate(userId,{
    ...
    //TODO : UPDATE THE INFO IN STREAM
    try {
       await upsertStreamUser({
